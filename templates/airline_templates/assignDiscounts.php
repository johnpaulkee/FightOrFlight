...
// Connect Oracle...
if ($db_conn) {
  $query = "UPDATE Airline_Employee_Employed_With SET discount='".$discval."' WHERE employeeID=".$empid."";
  $query2 = "SELECT employeeID, employee_name, discount FROM irline_Employee_Employed_With WHERE emplyeeID=".$empid."";

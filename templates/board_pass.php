...
function printResult($result) { //prints results from a select statement
	...
	echo "<thead>";
	echo "<tr>";
	echo "<th>boarding_ID</th>";
	echo "<th>flight_num</th>";
	echo "<th>weight</th>";
	echo "<th>seat number</th>";
	echo "<th>from_airport_code</th>";
	echo "<th>to_airport_code</th>";
...
if ($_POST && $success) {
	...
	$result = executePlainSQL("SELECT * from Boarding_Pass_For_Flight");
	printResult($result);
}
